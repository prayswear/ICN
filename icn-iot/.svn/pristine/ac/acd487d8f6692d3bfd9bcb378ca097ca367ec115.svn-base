...
def data_handler(client_socket, address):
...
def start_server():
    ...
    while True:
        ...
        threading._start_new_thread(data_handler, (client_socket, address))


if __name__ == '__main__':
    packet_server_ip, packet_server_port = '0.0.0.0', 12345
    start_server()
