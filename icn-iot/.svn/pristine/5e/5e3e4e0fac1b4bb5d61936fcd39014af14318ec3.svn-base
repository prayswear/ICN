...
mac_list = ["20:6b:e7:45:d7:1e","20:6b:e7:45:d6:04","88:10:36:30:30:f1","88:10:36:30:41:61","88:10:36:30:40:ec"]
ip_list = ['192.168.100.133','192.168.100.138','192.168.10.234','192.168.2.234','192.168.3.234']
state = [0,0,0,0,0]
state_old = [0,0,0,0,0]
    ...
    #        print ("%d -> %d" % (state_old[i],state[i]))
        ...
        for i in range(sizeofmac_list):
            if state[i] > state_old[i]:
                ...
                udp_gnrs_reg('b498dce7ea1f7a1a1b11a48dfef58303',nowna)
                for i1 in result1:
                    logger.info(i1)
